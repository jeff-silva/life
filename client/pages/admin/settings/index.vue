<template>
    <div>
        ...
        <ui-field label="Timezone" layout="horizontal">
            <el-select v-model="value['app.timezone']" filterable class="w-100">
                <el-option v-for="t in timezones" :key="t" :value="t"> {{ t }}</el-option>
            </el-select>
        </ui-field>
        
        <!-- Implementar de https://flagpedia.net/download/api -->
        <ui-field label="Locale" layout="horizontal">
            <el-select v-model="value['app.locale']" filterable class="w-100">
                <el-option v-for="t in locales" :key="t.code" :value="t.code" :label="t.name">
                    <img :src="t.flag" alt="" class="me-2"> {{ t.name }}
                </el-option>
            </el-select>
        </ui-field>
