...
class AppBase extends \Illuminate\Console\Command
{
    ...
    public function ignoredTables()
    {
        return ['failed_jobs', 'migrations', 'password_resets', 'personal_access_tokens'];
    }

    public function ignoredTable($name)
    {
        return in_array($name, $this->ignoredTables());
    }
